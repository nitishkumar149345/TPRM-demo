...
def download_file_content(bucket_name, object_name, output_file_path):
    ...
    try:
        ...
        logger.info(f'{object_name} downloaded from s3')
        # contents = data['Body'].read()
        # return contents.decode("utf-8")
        return output_file_path

    except Exception as e:
        logger.info(f'Exception while downloading content: {str(e)}')
...
def upload_file_content(bucket_name, object_name, file_content):
    ...
    try:
        ...
        logger.info(f'Response of put_object: {response}')
        return response

    except Exception as e:
        logger.error(f'Exception while put_object: {str(e)}')
        return None
...
def copy_file(source_bucket_name, source_key, destination_bucket_name, destination_key):
    ...
    try:
        ...
        logger.info(f'Response of copy_object: {response}')
        return response

    except Exception as e:
        logger.info(f'Exception while copy_object: {str(e)}')
        return None
...
def delete_file(bucket_name, source_key):
    ...
    try:
        ...
        logger.info(f'Response of delete_object: {response}')
        return response

    except Exception as e:
        logger.info(f'Exception while delete_object: {str(e)}')
        return None
